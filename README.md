...
I explore the convergence of **Artificial Intelligence**, **Fundamental Physics**, and **Mysticism**. My work focuses on building sovereign systems that bridge the gap between data science and the underlying code of reality.

---

### The Magnum Opus: The Exocortex
I am architecting a **Sovereign ASI for the Home**—a personal "Exocortex".
...
* **Smart Home:** Home Assistant (Deep Integrations, Automation, Sensors, Actors)
...
True intelligence requires grounding in the fundamental laws of physics and consciousness. I aim to build systems that don't just simulate language, but model the causal fabric of reality itself.
